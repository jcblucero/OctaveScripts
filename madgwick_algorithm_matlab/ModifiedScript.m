...
load('madgwick_alg_data_degree.mat');
...
%SAMPLE_PERIOD = 1/256 #original
SAMPLE_PERIOD = 1/666;
%AHRS = MadgwickAHRS('SamplePeriod', SAMPLE_PERIOD, 'Beta', 0.1);
%AHRS = MahonyAHRS('SamplePeriod', SAMPLE_PERIOD, 'Kp', 0.3 );
 AHRS = MahonyAHRS('SamplePeriod', SAMPLE_PERIOD, 'Kp', 0.3, 'Ki', .13 );
 % AHRS = MahonyAHRS('SamplePeriod', SAMPLE_PERIOD, 'Kp', 0.13, 'Ki', .3);

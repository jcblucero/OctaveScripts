...
hold on;
plot(time, inertial_accel_1(:,1), 'r');
plot(time, inertial_accel_1(:,2), 'g');
plot(time, inertial_accel_1(:,3), 'b');
legend('X', 'Y', 'Z');
xlabel('Time (s)');
...
hold on;
plot(time, inertial_accel_2(:,1), 'r');
plot(time, inertial_accel_2(:,2), 'g');
plot(time, inertial_accel_2(:,3), 'b');
legend('X', 'Y', 'Z');
xlabel('Time (s)');
ylabel('Acceleration (g)');
